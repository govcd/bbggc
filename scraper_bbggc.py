"""
Begum Badrunnessa Govt. Girls' College (BBGGC) Multi-Batch Automation Scraper
Website: https://bbggc.eshiksaems.com
Credentials: bbggcstudent / bbggcstudent
...
COLLEGE_CODE = "bbggc"
COLLEGE_NAME = "Begum Badrunnessa Govt. Girls' College"
FIXED_PREFIX = "120"
ROLL_DIGITS = 3
HAS_APPLICATION_FORM_DEFAULT = True
GROUPS = {
    "Science": {"group_code": "011", "letter": "s", "subfolder": "science"},
    "Humanities": {"group_code": "022", "letter": "h", "subfolder": "humanities"},
    "Business Studies": {"group_code": "033", "letter": "b", "subfolder": "bstudies"}
}
...
class PortalSession:
    ...
    def authenticate(self):
        ...
        with sync_playwright() as pw:
            ...
            page.locator("input[name=username]").fill("bbggcstudent")
            page.locator("input[name=password]").fill("bbggcstudent")
